...
const PromptInput = ({ onSubmit, loading = false, placeholder = "Describe website you want to build....", large = false, autoFocus = false, variant = "default"}) => {
    ...
    if(variant === "glass") {
        return (
            <form onSubmit={handleSubmit} className="max-w-2xl w-full bg-white/10 backdrop-blur-xl rounded-xl ring-1 ring-white/25 focus-within:ring-2 focus-within:bg-white/30 overflow-hidden mt-6 transition" action="">
