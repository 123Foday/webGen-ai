    ...
    <div className="absolute inset-0 bg-zinc-950/40 backdrop-blur-xs flex items-center justify-center z-50">
        <div className="bg-white border border-zinc-200 shadow-lg rounded-xl max-w-md w-full p-6 mx-4 relative">
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-zinc-500">Anyone with the link below can viw your published site.</p>
            </div>

            <div className="space-y-4">
                <div>
                    <label htmlFor="" className="block text-[10px] font-semibold text-zinc-400 uppercase tracking-widest mb-1.5">
                        Published Link
                    </label>
                ...
                <div className="flex gap-2 pt-2">
                    <button onClick={handleCopyLink} className="flex-1 py-2 bg-zinc-950 text-white rounded-e-xs font-medium hover:bg-zinc-800 cursor-pointer rounded-lg text-center">
                        Copy Link
                    </button>
                    <button 
