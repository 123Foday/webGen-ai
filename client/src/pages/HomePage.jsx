...
const HomePage = () => {
    ...
    const { user, projects, loadProjects, generatingProject, loadingProjects, handleGenerate, handleDelete, logout } = useAppContext();
    ...
    <div className="h-screen overflow-y-scroll text-white font-sans bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat">
       ...
       <nav className="sticky top-0 z-10 flex items-center justify-between px-6 py-4">
        <div className=" flex items-center gap-2">
            ...
            <span className="text-xl font-semibold tracking-tight">WegGen AI</span>
        </div>
       ...
       {/* Hero */}
       <div className=" flex-1 flex flex-col items-center justify-center py-px pb-20 mt-8 xl:mt-28">
        <div className="w-full max-w-2xl flex flex-col items-center">
            ...
            <p className="text-center text-sm md:text-base max-w-xl mt-4 text-white/65 leading-relaxed">
                Describe your idea and watch AI design, structure, and launch yur website instantly. No coding required
            </p>

            {/* Prompt input with glassmorphic vairiant */}
                        ...
                        {projects.map((p)=> (
                            ...
                            onClick={()=> navigate(`/builder/${p._id}`)}>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <ArrowRightIcon size={14} className="text-zinc-200 group-hover:white" />
                                </div>
                            </div>
                        ))}
                    </div>
