...
// Background worker to progressive generate files an update database in real-time
async function runBackgroundGeneration(projectId, prompt) {
    try {
        ...
        console.log(`[Background AI] Succcessfully generated project ${projectId}`);
...
// Make a project as publicly published.
